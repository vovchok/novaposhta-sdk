...
class DocumentUpdateMethodProperties extends MethodProperties
{
    ...
    public function setVolumeGeneral($volumeGeneral)
    {
        $this->__set('VolumeGeneral', $volumeGeneral);
    }

    public function getVolumeGeneral()
    {
        $this->__get('VolumeGeneral');
    }
